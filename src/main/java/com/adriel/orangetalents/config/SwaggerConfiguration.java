...
public class SwaggerConfiguration {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.globalResponseMessage(RequestMethod.POST, Arrays.asList(m201, m403, m400, m500))
				.globalResponseMessage(RequestMethod.PUT, Arrays.asList(m204put, m403, m404, m400, m500))
				.globalResponseMessage(RequestMethod.DELETE, Arrays.asList(m204del, m403, m404, m500))
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.adriel.orangetalents.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
		 "API feita para teste da ZUP INNOVATION",
		 "Esta API é utilizada no teste da zup innovation",
		 "Versão 1.0",
		 "https://github.com/ryanadriel",
		 new Contact("Ryan Adriel", "https://github.com/ryanadriel", "adrielryan.tj@hotmail.com"),
